//
//  BezierPathFromString.m
//  TopVideoEditor
//
//  Created by WangZhengHong on 2022/5/9.
//

#import "BezierPathFromString.h"

@implementation BezierPathFromString
- (UIBezierPath *)transformToBezierPath:(NSString *)string
{
    CGMutablePathRef paths = CGPathCreateMutable();
    CFStringRef fontNameRef = CFSTR("AvenirNext-DemiBold");
    CTFontRef fontRef = CTFontCreateWithName(fontNameRef, 100, nil);
